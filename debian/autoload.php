...
require_once '/usr/share/php/League/Config/autoload.php';
require_once '/usr/share/php/Psr/EventDispatcher/autoload.php';

spl_autoload_register(function (string $class): void {
    $prefix = 'League\\CommonMark\\';
    if (str_starts_with($class, $prefix)) {
        $file = '/usr/share/php/League/CommonMark/' . str_replace('\\', '/', substr($class, strlen($prefix))) . '.php';
        if (file_exists($file)) {
            require $file;
        }
    }
